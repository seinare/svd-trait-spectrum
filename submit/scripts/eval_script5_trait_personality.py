...
def main():
    ...
    try:
        ...
        if args.batch_size and args.batch_size > 0:
            ...
            for start in tqdm(range(0, total_prompts, args.batch_size), desc="vLLM batches"):
                batch = prompt_token_ids[start : start + args.batch_size]
                outputs.extend(llm.generate(prompt_token_ids=batch, sampling_params=sampling))
        else:
